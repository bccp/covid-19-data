...
def pop_ratio(cls=1, poplim = None):
    ...
    if poplim is not None: dfsave.to_csv('../data/Italy/upto_june_end/regional_population_fraction_%d.tsv'%poplim, sep='\t', encoding='utf-8')
    else: dfsave.to_csv('../data/Italy/upto_june_end/regional_population_fraction.tsv', sep='\t', encoding='utf-8')
