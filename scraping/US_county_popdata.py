...
def collect_and_save():
    ...
    df1 = pd.read_csv('../data/US/US_county_pop_data.csv')
    ...
    colheader = ['state', 'county_name', 'fips', 'population_2010', 'housing_units', 'total_area_sqmiles', 'land_area_sqmiles', 'population_denisty', 'housing_denisty', 'population_2010_est', 'population_2019_est']
