...
def regional(cls=1):
    ...
    df = pd.read_csv('../data/Italy/may4_total_deaths_2015-2020/comuni_giornaliero.csv', encoding='latin1')
    ...
    if cls == 1:
        ...
        print('Class not found, should be 1 or 2')
        sys.exit(-1)    
    ...
    dfsave.to_csv('../data//Italy/may4_total_deaths_2015-2020/regional_historic_mortality_cl%d.tsv'%cls, sep='\t', encoding='utf-8')

    


def pop_ratio(cls, poplim = None):
    ...
    if poplim is not None: dfsave.to_csv('../data/Italy/may4_total_deaths_2015-2020/regional_population_fraction_%d.tsv'%poplim, sep='\t', encoding='utf-8')
    else: dfsave.to_csv('../data/Italy/may4_total_deaths_2015-2020/regional_population_fraction_cl%d.tsv'%cls, sep='\t', encoding='utf-8')
